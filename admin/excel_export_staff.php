...
$sql = query("SELECT u.depart, i.id,i.requestors_name, i.today_date, i.date_needed,i.requests_choose, i.notes_sharing,i.notes_others,i.director, i.it_team, i.status, i.done_by FROM users AS u INNER JOIN tb_requests AS i ON u.id = i.id_users WHERE i.id_users = $id_author ORDER BY i.today_date DESC");
?>
